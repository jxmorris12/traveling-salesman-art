...
def generate_voronoi_diagram(num_cells, iter_limit):
  image = Image.open("pics/smiley-grad.png").convert("L") 
  ...
  for iterator in range(iter_limit):
    print "Iteration",iterator+1,"of",iter_limit
    #
    #
    # shade regions
    for y in range(imgy):
...
generate_voronoi_diagram(5000,2)
